...
- [TYPOGRAPHY & SPACING (iconic shortcuts)](#typography-and-spacing-(iconic-shortcuts))
- [SMART QUOTES (iconic shortcuts)](#smart-quotes-(iconic-shortcuts))
- [INTERNATIONAL PUNCTUATION (iconic shortcuts)](#international-punctuation-(iconic-shortcuts))
- [INTERNATIONAL DIACRITICS (prefix: i)](#international-diacritics-(prefix:-i))
- [UNITS & MEASUREMENTS (prefix: h, iconic)](#units-and-measurements-(prefix:-h,-iconic))
- [CHEMISTRY (prefix: h, iconic)](#chemistry-(prefix:-h,-iconic))
- [ASTRONOMY (prefix: h, iconic)](#astronomy-(prefix:-h,-iconic))
...
- [LEGAL / DOCUMENT SYMBOLS (iconic shortcuts)](#legal---document-symbols-(iconic-shortcuts))

---

## GREEK LETTERS  (prefix: g)

| Symbol | Code | Iconic | Mnemonic | Description |
|:------:|:----:|:-------|:---------|:------------|
...
| **ρ** | 03C1 | - | `g r` | Greek small letter rho |
...
| **∛** | 221B | `3 / v` | `h c b r t` | Cube root (visual: 3rd root, extends /v pattern) |
| **∠** | 2220 | - | `h A N` | Angle |
...
| **∋** | 220B | - | `h n i` | Contains as member (ni = reverse of "in") |
...
| **≅** | 2245 | - | `I S`<br>`h i s o m` | Approximately equal to (isomorphism) |
...
| **ɑ** | 0251 | - | `p A A` | IPA open back unrounded vowel |
...
| Symbol | Code | Iconic | Mnemonic | Description |
|:------:|:----:|:-------|:---------|:------------|
| **€** | 20AC | `E =` | `c e` | Euro sign |
| **£** | 00A3 | `L -` | `c p` | Pound sign |
| **¥** | 00A5 | `Y -` | `c y` | Yen sign |
| **₹** | 20B9 | `R |` | `c r` | Indian rupee sign |
| **₿** | 20BF | `B b` | `c b` | Bitcoin sign |
| **₽** | 20BD | `R u` | `c R` | Ruble sign |
| **₩** | 20A9 | `W =` | `c w` | Won sign (KRW) |
| **₫** | 20AB | `D =` | `c d` | Dong sign (VND) |
| **₪** | 20AA | `N =` | `c s` | New shekel sign (ILS) |
| **₺** | 20BA | `T L` | `c t` | Turkish lira sign (TRY) |
| **₣** | 20A3 | `F r` | `c f` | French franc sign (legacy) |
| **¤** | 00A4 | `X X` | `c x` | Generic currency sign |
...
- **Iconic**: Sequences that visually resemble the output (e.g., `->`, `<=`, `!=`)
- **Mnemonic**: Letter-based sequences with systematic prefixes:
